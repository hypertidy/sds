...
esacci_chlor_a <- function(time.resolution = "monthly") {
  template <- "/vsicurl/https://projects.pawsey.org.au/idea-esacci/www.oceancolour.org/thredds/fileServer/cci/v6.0-release/geographic/monthly/chlor_a/%s/ESACCI-OC-L3S-CHLOR_A-MERGED-1M_MONTHLY_4km_GEO_PML_OCx-%s-fv6.0.tif"
...
esacci_chlor_a_netcdf <- function(time.resolution = "monthly") {
