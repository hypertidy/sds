...
[![CRAN
status](https://www.r-pkg.org/badges/version/sds)](https://CRAN.R-project.org/package=sds)
[![R-CMD-check](https://github.com/hypertidy/sds/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/hypertidy/sds/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
